...
New-DistributionGroup -Name $hab -DisplayName $hab -OrganizationalUnit "contoso.com/HAB" `
-SAMAccountName $hab -Type Distribution
...
New-DistributionGroup -Name $_.GroupName -OrganizationalUnit "contoso.com/HAB" `
-Type Distribution -SAMAccountName $_.GroupName
